 ...
 */
 ...
 // THE CONSIGNMENT FUNCTION
 
 $memberGuid = array('memberGuid' => 'd5dbffb4-0336-44bf-b72c-00fb9aaac759');
 $requiredFields = array('consignmentNumber');
 ...
 if( !class_exists( 'WP_Http' ) )
    include_once( ABSPATH . WPINC. '/class-http.php' );
		...
		$response = wp_remote_post( $url, $formData,  array(
											'method' => 'POST',
											'timeout' => 45,
											'redirection' => 5,
											'httpversion' => '1.1',
 ...
 <input id="memberGuid" name="memberGuid" type="hidden" />
